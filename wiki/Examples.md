...
API reference: [Run](https://github.com/sigee-min/runD/wiki/Run), [Compute](https://github.com/sigee-min/runD/wiki/Compute),
[Telemetry](https://github.com/sigee-min/runD/wiki/Telemetry), [Tasks](https://github.com/sigee-min/runD/wiki/Tasks), [Replay](https://github.com/sigee-min/runD/wiki/Replay),
[Network](https://github.com/sigee-min/runD/wiki/Network), [Math32](https://github.com/sigee-min/runD/wiki/Math32), [Math64](https://github.com/sigee-min/runD/wiki/Math64), and
[Cluster](https://github.com/sigee-min/runD/wiki/Cluster).

## Bit-Identical CPU And GPU Compute

The repository's [first-screen example](https://github.com/sigee-min/runD#see-it) declares one
...
[One Flow, Three Backends](https://github.com/sigee-min/runD/wiki/Compute#one-flow-three-backends), then move to
...
[Telemetry example](https://github.com/sigee-min/runD/wiki/Telemetry#first-use) is generated from its package
...
with the executable [Compute first success](https://github.com/sigee-min/runD/wiki/Compute#first-success).
...
[Record and Replay journey](https://github.com/sigee-min/runD/wiki/Replay#bind-once), then add persistence
through [checkpoint continuation](https://github.com/sigee-min/runD/wiki/Replay#checkpoint-and-resume).
...
operations](https://github.com/sigee-min/runD/wiki/Network#first-use). Task code lends a `SocketView` directly;
...
[Network API](https://github.com/sigee-min/runD/wiki/Network). Those are byte and lifecycle helpers; protocol
...
example](https://github.com/sigee-min/runD/wiki/Network#bounded-server) returns one `PeerResult`; RAII owns every
