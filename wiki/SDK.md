...
Choose that directory only after checking [Platform Support](https://github.com/sigee-min/runD/blob/main/wiki/Platforms)
and completing the one-command verifier in
[Release Artifacts](https://github.com/sigee-min/runD/blob/main/wiki/Artifacts). The verifier admits only the exact
...
Use [Public API Surface](https://github.com/sigee-min/runD/blob/main/wiki/Surface) as the direct-include reference.
...
For the current public boundary, see [API Stability](https://github.com/sigee-min/runD/blob/main/wiki/Stability). For
artifact verification, see [Release Checklist](https://github.com/sigee-min/runD/blob/main/wiki/Checklist).
