...
inline Vec2x Load(const Vec2View view, const u64 lane_base) noexcept {
  return Vec2x{.x = simd::LoadI64(view.x.data() + lane_base), .y = simd::LoadI64(view.y.data() + lane_base)};
}

inline Vec3x Load(const Vec3View view, const u64 lane_base) noexcept {
  return Vec3x{.x = simd::LoadI64(view.x.data() + lane_base), .y = simd::LoadI64(view.y.data() + lane_base), .z = simd::LoadI64(view.z.data() + lane_base)};
}
