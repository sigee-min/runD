...
[[nodiscard]] bool
DefaultScanDescriptor(const rund::kernel::ScanDesc &desc) noexcept;
...
[[nodiscard]] bool
DefaultGatherDescriptor(const rund::kernel::GatherDesc &desc) noexcept;

[[nodiscard]] bool
DefaultHistogramDescriptor(const rund::kernel::HistogramDesc &desc) noexcept;

[[nodiscard]] bool
DefaultPartitionDescriptor(const rund::kernel::PartitionDesc &desc) noexcept;

[[nodiscard]] bool
DefaultReduceDescriptor(const rund::kernel::ReduceDesc &desc) noexcept;

[[nodiscard]] bool
DefaultScatterDescriptor(const rund::kernel::ScatterDesc &desc) noexcept;
[[nodiscard]] bool DefaultScatterReduceDescriptor(
    const rund::kernel::ScatterReduceDesc &desc) noexcept;

[[nodiscard]] bool
DefaultStencilDescriptor(const rund::kernel::StencilDesc &desc) noexcept;

[[nodiscard]] bool
DefaultWindowDescriptor(const rund::kernel::WindowDesc &desc) noexcept;

[[nodiscard]] bool
DefaultTransformDescriptor(const rund::kernel::TransformDesc &desc) noexcept;

[[nodiscard]] bool
DefaultMatrixDescriptor(const rund::kernel::MatrixDesc &desc) noexcept;

[[nodiscard]] bool
DefaultFactorDescriptor(const rund::kernel::FactorDesc &desc) noexcept;

[[nodiscard]] bool
DefaultSolveDescriptor(const rund::kernel::SolveDesc &desc) noexcept;

[[nodiscard]] bool
DefaultSpectrumDescriptor(const rund::kernel::SpectrumDesc &desc) noexcept;
