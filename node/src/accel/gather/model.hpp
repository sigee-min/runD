...
struct GatherParams final {
  ...
  rund::kernel::u32 validation_groups = 0u;
};
...
static_assert(offsetof(GatherParams, validation_groups) == 20u);
...
static_assert(sizeof(decltype(GatherParams::validation_groups)) == 4u);
