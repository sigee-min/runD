...
rund::AccelCheck EncodePreparedMetalScanBuffers(
    ...
    const rund::kernel::u64 input_offset, const rund::kernel::u64 output_offset,
  ...
  return EncodeMetalScanBuffersImpl(
      ...
      status_buffer, command_encoder, true, &prefix_execution, &block, &prefix,
      &offset, logical_count_buffer, count_words, input_offset, output_offset,
...
rund::AccelCheck EncodePreparedOffsetScan(
  ...
  return EncodeMetalScanBuffersImpl(
      ...
      nullptr, &block, &prefix, &offset, nullptr, 0u);
}
...
rund::AccelCheck EncodePreparedMetalScanBuffers(
  ...
  return EncodePreparedMetalScanBuffers(
      adapter, desc, plan, domain, input_buffer, output_buffer, totals_buffer,
      status_buffer, command_encoder, prefix_execution, block, prefix, offset,
      logical_count_buffer, count_words, input_offset, output_offset,
      logical_count_offset, totals_offset);
}
