...
inline void FixedCompare(const Instruction &instruction, const PreparedRun &,
                         Values &values,
  ...
  for (std::size_t lane = 0u; lane < kLaneCount; ++lane) {
    const WideScalar lhs = AlignWideFraction(
        values.wide(instruction.node.lhs, lane), lhs_fraction, fraction);
    const WideScalar rhs = AlignWideFraction(
        values.wide(instruction.node.rhs, lane), rhs_fraction, fraction);
    bool result = false;
    switch (comparison) {
    case WideCompare::Eq:
      result = lhs == rhs;
...
inline void ExecuteEq(const Instruction &instruction,
  ...
  values.set_raw(instruction.value_index,
                 BooleanValue(RUND_CPU_SIMD_EQ(values[instruction.node.lhs],
...
inline void ExecuteNe(const Instruction &instruction,
  ...
  values.set_raw(instruction.value_index,
                 BooleanValue(RUND_CPU_SIMD_NE(values[instruction.node.lhs],
                                               values[instruction.node.rhs])));
}
...
inline void ExecuteLt(const Instruction &instruction,
  ...
  values.set_raw(instruction.value_index,
                 BooleanValue(ValueLt(prepared, values[instruction.node.lhs],
                                      values[instruction.node.rhs])));
}
...
inline void ExecuteLe(const Instruction &instruction,
  ...
  values.set_raw(instruction.value_index,
                 BooleanValue(ValueLe(prepared, values[instruction.node.lhs],
                                      values[instruction.node.rhs])));
}
...
inline void ExecuteGt(const Instruction &instruction,
  ...
  values.set_raw(instruction.value_index,
                 BooleanValue(ValueGt(prepared, values[instruction.node.lhs],
                                      values[instruction.node.rhs])));
}
...
inline void ExecuteGe(const Instruction &instruction,
  ...
  values.set_raw(instruction.value_index,
                 BooleanValue(ValueGe(prepared, values[instruction.node.lhs],
                                      values[instruction.node.rhs])));
}
...
inline void ExecuteLtUnsigned(const Instruction &instruction,
  ...
  values.set_raw(
      ...
      BooleanValue(RUND_CPU_SIMD_LT_UNSIGNED(values[instruction.node.lhs],
                                             values[instruction.node.rhs])));
}
...
inline void ExecuteLeUnsigned(const Instruction &instruction,
  ...
  values.set_raw(
      instruction.value_index,
      BooleanValue(RUND_CPU_SIMD_LE_UNSIGNED(values[instruction.node.lhs],
                                             values[instruction.node.rhs])));
}
...
inline void ExecuteGtUnsigned(const Instruction &instruction,
  ...
  values.set_raw(
      instruction.value_index,
      BooleanValue(RUND_CPU_SIMD_GT_UNSIGNED(values[instruction.node.lhs],
                                             values[instruction.node.rhs])));
}
...
inline void ExecuteGeUnsigned(const Instruction &instruction,
  ...
  values.set_raw(
      instruction.value_index,
      BooleanValue(RUND_CPU_SIMD_GE_UNSIGNED(values[instruction.node.lhs],
                                             values[instruction.node.rhs])));
}
