...
ExecuteCpuScan(const rund::AccelDevice &pick,
...
[[nodiscard]] rund::AccelCheck
ExecuteCpuSort(const rund::AccelDevice &pick,
...
[[nodiscard]] rund::AccelCheck ExecuteCpuCompact(
    ...
    const rund::kernel::CompactPlan &plan, const CompactBinds &bindings);
...
[[nodiscard]] rund::AccelCheck ExecuteCpuScatter(
    ...
    const rund::kernel::ScatterPlan &plan, const ScatterBinds &bindings);
[[nodiscard]] rund::AccelCheck
ExecuteCpuScatterReduce(const rund::AccelDevice &pick,
