...
void append_pipeline_residency(
    ...
    std::uint64_t logical_bytes, std::uint64_t input_page_bytes,
    std::uint64_t output_page_bytes, std::uint64_t staging_bytes,
    std::uint64_t resident_bytes, std::uint32_t slot_count) noexcept;
