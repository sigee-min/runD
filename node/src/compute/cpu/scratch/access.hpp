...
template <class Lane>
[[nodiscard]] bool cpu_factor_scratch(
    CpuPrimitiveScratch &scratch, const kernel::FactorPlan &plan,
...
template <class Lane>
[[nodiscard]] bool cpu_solve_scratch(
    CpuPrimitiveScratch &scratch, const kernel::SolvePlan &plan,
...
template <class Lane>
[[nodiscard]] bool cpu_spectrum_scratch(
    CpuPrimitiveScratch &scratch, const kernel::SpectrumPlan &plan,
