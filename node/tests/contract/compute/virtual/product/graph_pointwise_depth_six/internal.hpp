...
inline constexpr std::size_t StageCount = 6u;
...
// Three inputs plus six stage results fill the fixed nine-resource plan. Each
// stage remains individually valid while every adjacent composition exceeds
// ExpressionCapacity, preserving all six physical Pipeline authorities.
