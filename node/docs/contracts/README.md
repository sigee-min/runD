...
| [Compute Pipeline Residency](./compute/residency.md) | Device-global page-cache authority, compact linear and Graph schedules, deterministic eviction, prefetch, dirty writeback, and canonical plan identity. |
...
| [Accel Window](./accel/window.md) | Node-owned affine Sum/Min/Max Window admission, frozen Range execution, CPU reference, and Metal/Vulkan parity. |
