...
if(NOT version_result STREQUAL "0" OR package_version STREQUAL "")
  message(FATAL_ERROR "package version owner did not resolve an SDK version")
endif()
...
set(verifier_name "rund-sdk-${package_version}-darwin-arm64")
...
rund_write_artifact_identity_fixture(
  "${darwin_identity}" darwin-arm64 "${public_target}" "${package_version}")

set(linux_identity "${fixture}/linux.tsv")
rund_write_artifact_identity_fixture(
  "${linux_identity}" linux-x64 "${public_target}" "${package_version}")

function(run_identity identity triplet result output)
  execute_process(
    COMMAND "${CMAKE_COMMAND}"
      -D "IDENTITY=${identity}"
      -D "EXPECTED_SDK_VERSION=${package_version}"
