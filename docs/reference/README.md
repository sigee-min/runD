...
This directory holds stable evidence snapshots that support implementation
decisions.
...
- measurement notes with command, platform, input, and output
- glossary entries that are shared across subsystems
- primary external references that are not already captured in subsystem docs

Do not use this directory for temporary scratch notes or task logs.
